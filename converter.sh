...
cd ./target/rp > /dev/null && zip -rq8 geyser_resources.mcpack . -x "*/.*" -x "textures/terrain_texture.json" && cd ../.. > /dev/null && mv ./target/rp/geyser_resources.mcpack ./target/packaged/geyser_resources.mcpack
